...
const Landing = () => {
    ...
    const handleEditTask = async (index) =>{
        ...
        if (newText !== null && newText !== '') {
            ...
            try {
                const res = await axios.put(`/todo/edittask/${taskid}`, {
    ...
    }, [todoAdded, todoDeleted, taskAdded, taskDeleted, taskEdited, todoEditted]);
    return (
        <>
            <ToastContainer
                position="top-right"
                        ...
                        <tbody>
                            {
                                todos.map(todo => (
                                    <tr key={todo._id} className="border-b border-opacity-20 border-gray-300 bg-gray-50">
                                        ...
                                        <td className="p-3 ">
                                            <button  className="px-3 py-1 font-semibold rounded-md bg-indigo-600 text-gray-50">
                                ...
                                <tbody>
                                    {
                                        ...
                                        tasks.map((task, index) => (
                                            <tr tr key={todo._id} className="border-b border-opacity-20 border-gray-300 bg-gray-50" >
                                                ...
                                                <td className="p-3">
                <button onClick={() => handleEditTask(index)} className="px-3 py-1 font-semibold rounded-md bg-indigo-600 text-gray-50">
                    Edit
                </button>
            </td>
                                                <td className="p-3">
                                                    <button onClick={() => handleTaskDelete( index)} className="px-3 py-1 font-semibold rounded-md bg-indigo-600 text-gray-50">
                                                        Delete
                                                    </button>
                                                </td>
                                            </tr>
